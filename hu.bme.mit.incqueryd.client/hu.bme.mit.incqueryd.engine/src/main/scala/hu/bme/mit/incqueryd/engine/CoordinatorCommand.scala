...
case class DeployInputNodes(vocabulary: Model, databaseConnection: DatabaseConnection, rmHostname: String, fileSystemUri: String) extends CoordinatorCommand
...
case object Dispose extends CoordinatorCommand
