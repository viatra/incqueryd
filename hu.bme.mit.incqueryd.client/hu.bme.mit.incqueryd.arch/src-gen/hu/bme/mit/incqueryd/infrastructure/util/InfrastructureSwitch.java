...
public class InfrastructureSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case InfrastructurePackage.PROCESS: {
				hu.bme.mit.incqueryd.infrastructure.Process process = (hu.bme.mit.incqueryd.infrastructure.Process)theEObject;
	 ...
	 * @generated
	 */
	public T caseProcess(hu.bme.mit.incqueryd.infrastructure.Process object) {
		return null;
	}
