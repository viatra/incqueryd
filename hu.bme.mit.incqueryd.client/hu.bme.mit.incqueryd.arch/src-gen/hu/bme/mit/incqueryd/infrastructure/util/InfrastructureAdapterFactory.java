/**
 */
package hu.bme.mit.incqueryd.infrastructure.util;
...
public class InfrastructureAdapterFactory extends AdapterFactoryImpl {
	...
	protected InfrastructureSwitch<Adapter> modelSwitch =
		new InfrastructureSwitch<Adapter>() {
			...
			@Override
			public Adapter caseProcess(hu.bme.mit.incqueryd.infrastructure.Process object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.bme.mit.incqueryd.infrastructure.Machine <em>Machine</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link hu.bme.mit.incqueryd.infrastructure.Process <em>Process</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
