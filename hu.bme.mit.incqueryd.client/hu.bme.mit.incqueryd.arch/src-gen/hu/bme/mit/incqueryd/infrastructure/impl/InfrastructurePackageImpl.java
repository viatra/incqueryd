...
import hu.bme.mit.incqueryd.infrastructure.InfrastructureFactory;
...
public class InfrastructurePackageImpl extends EPackageImpl implements InfrastructurePackage {
	 ...
	 * @see hu.bme.mit.incqueryd.infrastructure.InfrastructurePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(processEClass, hu.bme.mit.incqueryd.infrastructure.Process.class, "Process", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProcess_Port(), theEcorePackage.getEInt(), "port", null, 0, 1, hu.bme.mit.incqueryd.infrastructure.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getProcess_Memory(), theEcorePackage.getEInt(), "memory", null, 0, 1, hu.bme.mit.incqueryd.infrastructure.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getProcess_Machine(), this.getMachine(), this.getMachine_Processes(), "machine", null, 0, 1, hu.bme.mit.incqueryd.infrastructure.Process.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
