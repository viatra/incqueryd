...
import hu.bme.mit.incqueryd.arch.Role;
 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incqueryd.arch.impl.InfrastructureMappingImpl#getTraceInfo <em>Trace Info</em>}</li>
 *   <li>{@link hu.bme.mit.incqueryd.arch.impl.InfrastructureMappingImpl#getProcess <em>Process</em>}</li>
 *   <li>{@link hu.bme.mit.incqueryd.arch.impl.InfrastructureMappingImpl#getRoles <em>Roles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InfrastructureMappingImpl extends MinimalEObjectImpl.Container implements InfrastructureMapping {
	 ...
	 * @ordered
	 */
	protected hu.bme.mit.incqueryd.infrastructure.Process process;
	 ...
	 * @generated
	 */
	public hu.bme.mit.incqueryd.infrastructure.Process getProcess() {
		if (process != null && process.eIsProxy()) {
			InternalEObject oldProcess = (InternalEObject)process;
			process = (hu.bme.mit.incqueryd.infrastructure.Process)eResolveProxy(oldProcess);
	 ...
	 * @generated
	 */
	public hu.bme.mit.incqueryd.infrastructure.Process basicGetProcess() {
		return process;
	}
	 ...
	 * @generated
	 */
	public void setProcess(hu.bme.mit.incqueryd.infrastructure.Process newProcess) {
		hu.bme.mit.incqueryd.infrastructure.Process oldProcess = process;
		process = newProcess;
		if (eNotificationRequired())
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ArchPackage.INFRASTRUCTURE_MAPPING__TRACE_INFO:
				...
				return;
			case ArchPackage.INFRASTRUCTURE_MAPPING__PROCESS:
				setProcess((hu.bme.mit.incqueryd.infrastructure.Process)newValue);
				return;
			case ArchPackage.INFRASTRUCTURE_MAPPING__ROLES:
				getRoles().clear();
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case ArchPackage.INFRASTRUCTURE_MAPPING__TRACE_INFO:
				...
				return;
			case ArchPackage.INFRASTRUCTURE_MAPPING__PROCESS:
				setProcess((hu.bme.mit.incqueryd.infrastructure.Process)null);
				return;
			case ArchPackage.INFRASTRUCTURE_MAPPING__ROLES:
				getRoles().clear();
				return;
