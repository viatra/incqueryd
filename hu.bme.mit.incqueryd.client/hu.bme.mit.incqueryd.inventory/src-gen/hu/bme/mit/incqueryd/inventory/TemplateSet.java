 ...
 * <ul>
 *   <li>{@link hu.bme.mit.incqueryd.inventory.TemplateSet#getMachineTemplates <em>Machine Templates</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.incqueryd.inventory.InventoryPackage#getTemplateSet()
 * @model
 * @generated
 */
public interface TemplateSet extends MachineSet {
	 ...
	 * The list contents are of type {@link hu.bme.mit.incqueryd.inventory.MachineTemplate}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see hu.bme.mit.incqueryd.inventory.InventoryPackage#getTemplateSet_MachineTemplates()
