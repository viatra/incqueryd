...
import hu.bme.mit.incqueryd.inventory.MachineSet;
import hu.bme.mit.incqueryd.inventory.MachineTemplate;
import hu.bme.mit.incqueryd.inventory.MemoryUnit;
import hu.bme.mit.incqueryd.inventory.TemplateSet;
...
public class InventoryPackageImpl extends EPackageImpl implements InventoryPackage {
	 ...
	 * @see hu.bme.mit.incqueryd.inventory.InventoryPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getMachine_MemorySize(), theEcorePackage.getELong(), "memorySize", null, 0, 1, Machine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
