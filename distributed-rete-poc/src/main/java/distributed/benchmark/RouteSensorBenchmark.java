...
public class RouteSensorBenchmark {
	...
	public Map<Long, Long> edit() {
		...
		// important: Neo4j returns the routeIds in random order, to get deterministic results, we have to sort the list
		// Collections.sort(routeIds); // this happens in Cypher now
