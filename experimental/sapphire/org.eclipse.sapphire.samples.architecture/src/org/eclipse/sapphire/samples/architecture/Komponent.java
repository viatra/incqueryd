...
public interface Komponent extends Component {
	ElementType TYPE = new ElementType(Komponent.class);
	...
	ImpliedElementProperty PROP_POSITION = new ImpliedElementProperty(TYPE,
			"Position");
