...
In this chapter, we provide examples for the different graph formats, including property graphs and RDF graphs. The examples describe a small instance model based on the railway system metamodel, shown on \figref{trainbenchmark-instancemodel-subgraph}.

\myFigureSmall{trainbenchmark-instancemodel-subgraph}{An example graph based on the railway system metamodel}
