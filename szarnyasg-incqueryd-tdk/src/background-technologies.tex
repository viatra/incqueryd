...
Akka's remoting is more lightweight than traditional remoting solutions. e.g.\ Java RMI (Remote Method Invocation). As of October 2013, the latest version (Akka 2.2) also features \textit{pluggable transport support}.
