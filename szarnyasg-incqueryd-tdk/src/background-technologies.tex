...
%Ez a rész lehetne általánosabb:
%metamodel = definition of Mod Lang, de szintén DB schema is ugyanez
%A példányszint szintén említhető, hiszen mind gráfok, mind hagyományos DB esetén értelmezhető (records)

%\subsection{Data Model Implementations}
