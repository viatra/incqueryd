...
Neo4j graphs can be visualized in Neoclipse, an Eclipse RCP application \cite{Neoclipse}. A part of a \tb (\autoref{sec:\tb}) instance model is shown on \figref{neoclipse-graph}. 
