...
\bf Ecore class & 
\bf Property graph &
\bf RDF \tabularnewline \hline\hline
\texttt{EClass}     & node type            & \texttt{rdfs:Class} \\ \hline
\texttt{EAttribute} & node property        & \texttt{rdf:Property} \\ \hline
\texttt{EReference} & edge                 & \texttt{rdf:Statement} \\ \hline
\texttt{EDataType}  & Java primitive types & \texttt{rdfs:Datatype} \\ \hline
...
Ecore -> property graphy mapping \autoref{tab:ecore-mapping}
