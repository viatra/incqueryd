...
\pic{trainBenchmark_IncQuery_RouteSensor}{\tb{}: reponse times for incremental query evaluation, measured on a single node \cite{TrainBenchmark}}
...
\pic{trainBenchmark_Memory_User_RouteSensor}{\tb{}: memory consumption of the tools \cite{TrainBenchmark}}
