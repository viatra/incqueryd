...
nohup $RUN_JAVA -server $JAVA_OPTS -Dhazelcast.config=$HZ_HOME/bin/hazelcast.xml com.hazelcast.core.server.StartServer > $HZ_HOME/hazelcast.log 2>&1&
