 ...
 * generated by Xtext
 */
package hu.bme.mit.incqueryd.mondixschema.language.formatting
 ...
 */
public class MondixSchemaFormatter extends AbstractDeclarativeFormatter {
	
	@Inject extension MondixSchemaGrammarAccess
