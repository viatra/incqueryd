		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBaseIriValueAccess().getGroup(), "rule__BaseIriValue__Group__0");
					...
					put(grammarAccess.getRdfPatternModelAccess().getBaseIriValueAssignment_1(), "rule__RdfPatternModel__BaseIriValueAssignment_1");
