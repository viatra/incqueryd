...
import org.eclipse.incquery.patternlanguage.rdf.ide.contentassist.antlr.PartialRdfPatternLanguageContentAssistParser;
import org.eclipse.incquery.patternlanguage.rdf.ide.contentassist.antlr.RdfPatternLanguageParser;
import org.eclipse.incquery.patternlanguage.rdf.ui.contentassist.RdfPatternLanguageProposalProvider;
import org.eclipse.incquery.patternlanguage.rdf.ui.labeling.RdfPatternLanguageLabelProvider;
import org.eclipse.incquery.patternlanguage.rdf.ui.outline.RdfPatternLanguageOutlineTreeProvider;
import org.eclipse.incquery.patternlanguage.rdf.ui.quickfix.RdfPatternLanguageQuickfixProvider;
...
/**
 * Manual modifications go to {@link RdfPatternLanguageUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractRdfPatternLanguageUiModule extends DefaultXbaseUiModule {

	public AbstractRdfPatternLanguageUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ide.LexerIdeBindings.HIGHLIGHTING)).to(org.eclipse.incquery.patternlanguage.rdf.parser.antlr.internal.InternalRdfPatternLanguageLexer.class);
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return RdfPatternLanguageLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(org.eclipse.incquery.patternlanguage.rdf.ui.labeling.RdfPatternLanguageDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return RdfPatternLanguageOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return RdfPatternLanguageQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.ui.generator.contentAssist.ContentAssistFragment
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return RdfPatternLanguageProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialRdfPatternLanguageContentAssistParser.class;
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(org.eclipse.incquery.patternlanguage.rdf.ide.contentassist.antlr.internal.InternalRdfPatternLanguageLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(org.eclipse.incquery.patternlanguage.rdf.ide.contentassist.antlr.internal.InternalRdfPatternLanguageLexer.class));
	}
	
	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.ide.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ide.LexerIdeBindings.CONTENT_ASSIST)).to(org.eclipse.incquery.patternlanguage.rdf.ide.contentassist.antlr.internal.InternalRdfPatternLanguageLexer.class);
	}
