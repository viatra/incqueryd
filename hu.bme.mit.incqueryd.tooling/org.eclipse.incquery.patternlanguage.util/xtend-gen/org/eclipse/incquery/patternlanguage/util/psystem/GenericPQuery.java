...
public class GenericPQuery implements PQuery, Serializable {
  ...
  public GenericPQuery(final Pattern pattern, final Function2<? super PatternBody, ? super PQuery, ? extends PBody> transformBody) {
    ...
    final Function1<PatternBody, PBody> _function_2 = new Function1<PatternBody, PBody>() {
      public PBody apply(final PatternBody it) {
        return transformBody.apply(it, GenericPQuery.this);
      }
    };
  ...
  public boolean equals(final Object q) {
    ...
    if ((!(q instanceof GenericPQuery))) {
      _xifexpression = false;
    } else {
      _xifexpression = this.pattern.equals(((GenericPQuery) q).pattern);
    }
