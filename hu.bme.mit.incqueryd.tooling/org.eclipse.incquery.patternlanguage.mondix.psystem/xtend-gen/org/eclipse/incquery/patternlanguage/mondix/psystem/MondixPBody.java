...
import org.eclipse.incquery.patternlanguage.mondix.psystem.MondixPConstraint;
...
public class MondixPBody {
  public static PBody toPBody(final PatternBody body, final Pattern pattern, final PQuery query, final MondixPModel model) {
      ...
      public void apply(final PBody pBody) {
        ...
        final Function1<Variable, ExportedParameter> _function = new Function1<Variable, ExportedParameter>() {
          public ExportedParameter apply(final Variable parameter) {
            return MondixPBody.toExportedParameter(parameter, pBody);
          }
        };
        ...
        final Function1<Constraint, PConstraint> _function_1 = new Function1<Constraint, PConstraint>() {
          public PConstraint apply(final Constraint constraint) {
            return MondixPConstraint.toPConstraint(constraint, pBody, model);
          }
        };
