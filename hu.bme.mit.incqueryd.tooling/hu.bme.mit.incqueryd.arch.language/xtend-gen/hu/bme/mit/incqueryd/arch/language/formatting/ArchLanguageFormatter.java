 ...
 * generated by Xtext
 */
package hu.bme.mit.incqueryd.arch.language.formatting;
...
public class ArchLanguageFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private ArchLanguageGrammarAccess _archLanguageGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._archLanguageGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._archLanguageGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._archLanguageGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._archLanguageGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._archLanguageGrammarAccess.getML_COMMENTRule();
