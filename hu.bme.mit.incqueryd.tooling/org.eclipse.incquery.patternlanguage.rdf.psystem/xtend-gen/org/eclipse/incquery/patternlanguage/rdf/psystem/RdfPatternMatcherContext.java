...
public class RdfPatternMatcherContext implements IPatternMatcherContext {
  ...
  public boolean isUnaryType(final Object typeObject) {
    boolean _or = false;
    boolean _isClass = RdfUtils.isClass(((Resource) typeObject), this.vocabulary);
    if (_isClass) {
      _or = true;
    } else {
      boolean _isDatatype = RdfUtils.isDatatype(((Resource) typeObject), this.vocabulary);
      _or = _isDatatype;
    }
    return _or;
  }
  ...
  public boolean isBinaryEdgeType(final Object typeObject) {
    return RdfUtils.isProperty(((Resource) typeObject), this.vocabulary);
  }
