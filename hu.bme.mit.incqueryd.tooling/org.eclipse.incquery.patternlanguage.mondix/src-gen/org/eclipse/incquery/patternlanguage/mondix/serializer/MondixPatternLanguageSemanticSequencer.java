package org.eclipse.incquery.patternlanguage.mondix.serializer;
...
public class MondixPatternLanguageSemanticSequencer extends PatternLanguageSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == MondixPatternLanguagePackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case PatternLanguagePackage.VARIABLE:
				if(context == grammarAccess.getVariableRule()) {
					sequence_Variable(context, (org.eclipse.incquery.patternlanguage.patternLanguage.Variable) semanticObject); 
					return; 
				}
				else break;
