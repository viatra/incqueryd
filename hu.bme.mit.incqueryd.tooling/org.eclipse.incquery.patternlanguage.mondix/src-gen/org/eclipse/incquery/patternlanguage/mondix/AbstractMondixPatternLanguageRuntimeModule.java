...
/**
 * Manual modifications go to {org.eclipse.incquery.patternlanguage.mondix.MondixPatternLanguageRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractMondixPatternLanguageRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/incquery/patternlanguage/mondix/MondixPatternLanguage.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.incquery.patternlanguage.mondix.MondixPatternLanguage");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("miq");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.eclipse.incquery.patternlanguage.mondix.services.MondixPatternLanguageGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.eclipse.incquery.patternlanguage.mondix.serializer.MondixPatternLanguageSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.eclipse.incquery.patternlanguage.mondix.serializer.MondixPatternLanguageSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.eclipse.incquery.patternlanguage.mondix.parser.antlr.MondixPatternLanguageParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.eclipse.incquery.patternlanguage.mondix.parser.antlr.MondixPatternLanguageAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.eclipse.incquery.patternlanguage.mondix.parser.antlr.internal.InternalMondixPatternLanguageLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.eclipse.incquery.patternlanguage.mondix.parser.antlr.internal.InternalMondixPatternLanguageLexer> provideInternalMondixPatternLanguageLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.eclipse.incquery.patternlanguage.mondix.parser.antlr.internal.InternalMondixPatternLanguageLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.eclipse.incquery.patternlanguage.mondix.parser.antlr.internal.InternalMondixPatternLanguageLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.eclipse.incquery.patternlanguage.mondix.validation.MondixPatternLanguageValidator> bindMondixPatternLanguageValidator() {
		return org.eclipse.incquery.patternlanguage.mondix.validation.MondixPatternLanguageValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.eclipse.incquery.patternlanguage.mondix.formatting.MondixPatternLanguageFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.eclipse.incquery.patternlanguage.mondix.jvmmodel.MondixPatternLanguageJvmModelInferrer.class;
	}
