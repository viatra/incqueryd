...
/**
 * This is the item provider adapter for a {@link inventory.Inventory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InventoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inventory_connectionString_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inventory_connectionString_feature", "_UI_Inventory_type"),
				 InventoryPackage.Literals.INVENTORY__CONNECTION_STRING,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(InventoryPackage.Literals.INVENTORY__MACHINE_SET);
		}
	...
	public String getText(Object object) {
		String label = ((Inventory)object).getConnectionString();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(InventoryPackage.Literals.INVENTORY__MACHINE_SET,
				 InventoryFactory.eINSTANCE.createInstanceSet()));

		newChildDescriptors.add
			(createChildParameter
				(InventoryPackage.Literals.INVENTORY__MACHINE_SET,
				 InventoryFactory.eINSTANCE.createTemplateSet()));
	}
