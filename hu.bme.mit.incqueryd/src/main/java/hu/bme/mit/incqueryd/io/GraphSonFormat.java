...
public class GraphSonFormat {
     ...
     * 
     * @param pathName
     * @param vertexTypesAndProperties
     *            See https://code.google.com/p/guava-libraries/wiki/NewCollectionTypesExplained#Multimap_Is_Not_A_Map.
     ...
     * @throws IOException
     */
    public static void indexGraph(final String pathName,
            final Map<String, Collection<String>> vertexTypesAndProperties,
            final Multimap<String, Object> vertexTypeVertexIdsMap,
    ...
    private static void extractVertexProperties(final FaunusVertex v,
            final Map<String, Collection<String>> vertexTypesAndProperties,
            final Multimap<String, Object> vertexTypeVertexIdsMap,
