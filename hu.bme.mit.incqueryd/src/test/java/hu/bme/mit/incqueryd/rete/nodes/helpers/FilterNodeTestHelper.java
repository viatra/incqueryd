...
public class FilterNodeTestHelper {
	...
	public static FilterNodeTestData data1() {
		...
		inequalityExpectedTuples.add(new TupleImpl(1, 2, 1, 3));		
		inequalityExpectedTuples.add(new TupleImpl(1, 2, 3, 1));
		...
		final FilterNodeTestData data1 = new FilterNodeTestData(changeSet, tupleMask, equalityExpectedResults, inequalityExpectedResults);		
		return data1;
	}
