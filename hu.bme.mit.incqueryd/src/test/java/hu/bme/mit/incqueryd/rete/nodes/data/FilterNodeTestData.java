...
public class FilterNodeTestData {
	...
	public FilterNodeTestData(final ChangeSet changeSet, final TupleMask tupleMask, final ChangeSet equalityExpectedResults,
			final ChangeSet inequalityExpectedResults) {
