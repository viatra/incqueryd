 ...
 * <ul>
 *   <li>{@link infrastructure.impl.ServiceNodeImpl#getTraceInfo <em>Trace Info</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ServiceNodeImpl extends MinimalEObjectImpl.Container implements ServiceNode
{
  /**
  ...
  {
    return InfrastructurePackage.Literals.SERVICE_NODE;
  }
  ...
  public void setTraceInfo(String newTraceInfo)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, InfrastructurePackage.SERVICE_NODE__TRACE_INFO, oldTraceInfo, traceInfo));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case InfrastructurePackage.SERVICE_NODE__TRACE_INFO:
        return getTraceInfo();
    }
