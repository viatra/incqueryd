...
//		// -------------reference|---v1|v2|--
//		// ----------------------V-----V--V--
//		tuples.add(new Tuple(1, 2, 1, 1));
//		tuples.add(new Tuple(1, 2, 1, 3));
//		tuples.add(new Tuple(1, 2, 3, 1));
//		tuples.add(new Tuple(1, 2, 3, 3));
...
//		equalityExpectedTuples.add(new Tuple(1, 2, 1, 1));
...
//		inequalityExpectedTuples.add(new Tuple(1, 2, 3, 3));
//		inequalityExpectedTuples.add(new Tuple(1, 2, 3, 4));
