...
public interface ReteNodeRecipe extends EObject
{
   ...
   *        annotation="http://www.eclipse.org/emf/2002/GenModel body='<%java.lang.UnsupportedOperationException%> _unsupportedOperationException = new <%java.lang.UnsupportedOperationException%>();\nthrow _unsupportedOperationException;'"
   * @generated
   */
  int getArity();
