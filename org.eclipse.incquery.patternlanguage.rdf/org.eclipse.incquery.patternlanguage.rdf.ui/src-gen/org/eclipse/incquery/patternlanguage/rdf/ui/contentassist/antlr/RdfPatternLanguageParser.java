...
* generated by Xtext
*/
package org.eclipse.incquery.patternlanguage.rdf.ui.contentassist.antlr;
...
public class RdfPatternLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.incquery.patternlanguage.rdf.ui.contentassist.antlr.internal.InternalRdfPatternLanguageParser createParser() {
		org.eclipse.incquery.patternlanguage.rdf.ui.contentassist.antlr.internal.InternalRdfPatternLanguageParser result = new org.eclipse.incquery.patternlanguage.rdf.ui.contentassist.antlr.internal.InternalRdfPatternLanguageParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRdfCheckConstraintAccess().getGroup_3(), "rule__RdfCheckConstraint__Group_3__0");
					...
					put(grammarAccess.getRefTypeAccess().getGroup(), "rule__RefType__Group__0");
					put(grammarAccess.getRdfLiteralAccess().getGroup(), "rule__RdfLiteral__Group__0");
					put(grammarAccess.getRdfLiteralAccess().getGroup_1_0(), "rule__RdfLiteral__Group_1_0__0");
					put(grammarAccess.getRdfLiteralAccess().getGroup_1_1(), "rule__RdfLiteral__Group_1_1__0");
					...
					put(grammarAccess.getPatternAccess().getGroup_5(), "rule__Pattern__Group_5__0");
					put(grammarAccess.getPatternAccess().getGroup_5_1(), "rule__Pattern__Group_5_1__0");
					...
					put(grammarAccess.getAnnotationParameterAccess().getGroup(), "rule__AnnotationParameter__Group__0");
					...
					put(grammarAccess.getParameterRefAccess().getGroup_3(), "rule__ParameterRef__Group_3__0");
					...
					put(grammarAccess.getPatternBodyAccess().getGroup(), "rule__PatternBody__Group__0");
					put(grammarAccess.getPatternBodyAccess().getGroup_3(), "rule__PatternBody__Group_3__0");
					put(grammarAccess.getPatternCompositionConstraintAccess().getGroup(), "rule__PatternCompositionConstraint__Group__0");
					put(grammarAccess.getPatternCallAccess().getGroup(), "rule__PatternCall__Group__0");
					put(grammarAccess.getPatternCallAccess().getGroup_4(), "rule__PatternCall__Group_4__0");
					put(grammarAccess.getPatternCallAccess().getGroup_4_1(), "rule__PatternCall__Group_4_1__0");
					put(grammarAccess.getCompareConstraintAccess().getGroup(), "rule__CompareConstraint__Group__0");
					put(grammarAccess.getCheckConstraintAccess().getGroup(), "rule__CheckConstraint__Group__0");
					put(grammarAccess.getPathExpressionConstraintAccess().getGroup(), "rule__PathExpressionConstraint__Group__0");
					put(grammarAccess.getPathExpressionHeadAccess().getGroup(), "rule__PathExpressionHead__Group__0");
					put(grammarAccess.getPathExpressionTailAccess().getGroup(), "rule__PathExpressionTail__Group__0");
					put(grammarAccess.getPathExpressionTailAccess().getGroup_2(), "rule__PathExpressionTail__Group_2__0");
					put(grammarAccess.getPathExpressionTailAccess().getGroup_4(), "rule__PathExpressionTail__Group_4__0");
					put(grammarAccess.getIntValueAccess().getGroup(), "rule__IntValue__Group__0");
					put(grammarAccess.getINTNUMBERAccess().getGroup(), "rule__INTNUMBER__Group__0");
					...
					put(grammarAccess.getListValueAccess().getGroup_3(), "rule__ListValue__Group_3__0");
					put(grammarAccess.getFunctionEvaluationValueAccess().getGroup(), "rule__FunctionEvaluationValue__Group__0");
					put(grammarAccess.getAggregatedValueAccess().getGroup(), "rule__AggregatedValue__Group__0");
					put(grammarAccess.getAggregatorExpressionAccess().getGroup(), "rule__AggregatorExpression__Group__0");
					...
					put(grammarAccess.getRdfPatternModelAccess().getBaseAssignment_1(), "rule__RdfPatternModel__BaseAssignment_1");
					put(grammarAccess.getRdfPatternModelAccess().getPrefixesAssignment_2(), "rule__RdfPatternModel__PrefixesAssignment_2");
					put(grammarAccess.getRdfPatternModelAccess().getPatternsAssignment_3(), "rule__RdfPatternModel__PatternsAssignment_3");
					put(grammarAccess.getBaseAccess().getIriAssignment_1(), "rule__Base__IriAssignment_1");
					...
					put(grammarAccess.getRdfCheckConstraintAccess().getVariablesAssignment_3_0(), "rule__RdfCheckConstraint__VariablesAssignment_3_0");
					put(grammarAccess.getRdfCheckConstraintAccess().getExpressionAssignment_4(), "rule__RdfCheckConstraint__ExpressionAssignment_4");
					...
					put(grammarAccess.getTypeConstraintAccess().getTypeAssignment_0(), "rule__TypeConstraint__TypeAssignment_0");
					put(grammarAccess.getTypeConstraintAccess().getVarAssignment_2(), "rule__TypeConstraint__VarAssignment_2");
					put(grammarAccess.getTypeAccess().getClassAssignment_1(), "rule__Type__ClassAssignment_1");
					put(grammarAccess.getRefTypeAccess().getPropertyAssignment_1(), "rule__RefType__PropertyAssignment_1");
					...
					put(grammarAccess.getRdfLiteralAccess().getLanguageAssignment_1_1_1(), "rule__RdfLiteral__LanguageAssignment_1_1_1");
					...
					put(grammarAccess.getPatternAccess().getModifiersAssignment_1(), "rule__Pattern__ModifiersAssignment_1");
					put(grammarAccess.getPatternAccess().getNameAssignment_3(), "rule__Pattern__NameAssignment_3");
					put(grammarAccess.getPatternAccess().getParametersAssignment_5_0(), "rule__Pattern__ParametersAssignment_5_0");
					put(grammarAccess.getPatternAccess().getParametersAssignment_5_1_1(), "rule__Pattern__ParametersAssignment_5_1_1");
					put(grammarAccess.getPatternAccess().getBodiesAssignment_8(), "rule__Pattern__BodiesAssignment_8");
					put(grammarAccess.getPatternAccess().getBodiesAssignment_9_1(), "rule__Pattern__BodiesAssignment_9_1");
					put(grammarAccess.getAnnotationAccess().getNameAssignment_1(), "rule__Annotation__NameAssignment_1");
					put(grammarAccess.getAnnotationAccess().getParametersAssignment_2_1(), "rule__Annotation__ParametersAssignment_2_1");
					put(grammarAccess.getAnnotationAccess().getParametersAssignment_2_2_1(), "rule__Annotation__ParametersAssignment_2_2_1");
					put(grammarAccess.getAnnotationParameterAccess().getNameAssignment_0(), "rule__AnnotationParameter__NameAssignment_0");
					put(grammarAccess.getAnnotationParameterAccess().getValueAssignment_2(), "rule__AnnotationParameter__ValueAssignment_2");
					put(grammarAccess.getModifiersAccess().getPrivateAssignment(), "rule__Modifiers__PrivateAssignment");
					put(grammarAccess.getVariableAccess().getNameAssignment_1(), "rule__Variable__NameAssignment_1");
					put(grammarAccess.getVariableAccess().getTypeAssignment_2_1(), "rule__Variable__TypeAssignment_2_1");
					put(grammarAccess.getParameterRefAccess().getNameAssignment_1(), "rule__ParameterRef__NameAssignment_1");
					put(grammarAccess.getParameterRefAccess().getReferredParamAssignment_2(), "rule__ParameterRef__ReferredParamAssignment_2");
					put(grammarAccess.getParameterRefAccess().getTypeAssignment_3_1(), "rule__ParameterRef__TypeAssignment_3_1");
					...
					put(grammarAccess.getLocalVariableAccess().getTypeAssignment_2_1(), "rule__LocalVariable__TypeAssignment_2_1");
					put(grammarAccess.getVariableReferenceAccess().getVarAssignment(), "rule__VariableReference__VarAssignment");
					put(grammarAccess.getPatternBodyAccess().getNameAssignment_1(), "rule__PatternBody__NameAssignment_1");
					put(grammarAccess.getPatternBodyAccess().getConstraintsAssignment_3_0(), "rule__PatternBody__ConstraintsAssignment_3_0");
					put(grammarAccess.getPatternCompositionConstraintAccess().getNegativeAssignment_1(), "rule__PatternCompositionConstraint__NegativeAssignment_1");
					put(grammarAccess.getPatternCompositionConstraintAccess().getCallAssignment_2(), "rule__PatternCompositionConstraint__CallAssignment_2");
					put(grammarAccess.getPatternCallAccess().getPatternRefAssignment_1(), "rule__PatternCall__PatternRefAssignment_1");
					put(grammarAccess.getPatternCallAccess().getTransitiveAssignment_2(), "rule__PatternCall__TransitiveAssignment_2");
					put(grammarAccess.getPatternCallAccess().getParametersAssignment_4_0(), "rule__PatternCall__ParametersAssignment_4_0");
					put(grammarAccess.getPatternCallAccess().getParametersAssignment_4_1_1(), "rule__PatternCall__ParametersAssignment_4_1_1");
					put(grammarAccess.getCompareConstraintAccess().getLeftOperandAssignment_1(), "rule__CompareConstraint__LeftOperandAssignment_1");
					put(grammarAccess.getCompareConstraintAccess().getFeatureAssignment_2(), "rule__CompareConstraint__FeatureAssignment_2");
					put(grammarAccess.getCompareConstraintAccess().getRightOperandAssignment_3(), "rule__CompareConstraint__RightOperandAssignment_3");
					put(grammarAccess.getCheckConstraintAccess().getExpressionAssignment_3(), "rule__CheckConstraint__ExpressionAssignment_3");
					put(grammarAccess.getPathExpressionConstraintAccess().getHeadAssignment_1(), "rule__PathExpressionConstraint__HeadAssignment_1");
					put(grammarAccess.getPathExpressionHeadAccess().getTypeAssignment_1(), "rule__PathExpressionHead__TypeAssignment_1");
					put(grammarAccess.getPathExpressionHeadAccess().getTailAssignment_3(), "rule__PathExpressionHead__TailAssignment_3");
					put(grammarAccess.getPathExpressionHeadAccess().getSrcAssignment_5(), "rule__PathExpressionHead__SrcAssignment_5");
					put(grammarAccess.getPathExpressionHeadAccess().getDstAssignment_7(), "rule__PathExpressionHead__DstAssignment_7");
					put(grammarAccess.getPathExpressionTailAccess().getTypeAssignment_1(), "rule__PathExpressionTail__TypeAssignment_1");
					put(grammarAccess.getPathExpressionTailAccess().getIndexAssignment_2_1(), "rule__PathExpressionTail__IndexAssignment_2_1");
					put(grammarAccess.getPathExpressionTailAccess().getClosureAssignment_3(), "rule__PathExpressionTail__ClosureAssignment_3");
					put(grammarAccess.getPathExpressionTailAccess().getTailAssignment_4_1(), "rule__PathExpressionTail__TailAssignment_4_1");
					...
					put(grammarAccess.getDoubleValueAccess().getValueAssignment_1(), "rule__DoubleValue__ValueAssignment_1");
					put(grammarAccess.getVariableValueAccess().getValueAssignment_1(), "rule__VariableValue__ValueAssignment_1");
					put(grammarAccess.getListValueAccess().getValuesAssignment_2(), "rule__ListValue__ValuesAssignment_2");
					put(grammarAccess.getListValueAccess().getValuesAssignment_3_1(), "rule__ListValue__ValuesAssignment_3_1");
					put(grammarAccess.getFunctionEvaluationValueAccess().getExpressionAssignment_3(), "rule__FunctionEvaluationValue__ExpressionAssignment_3");
					put(grammarAccess.getAggregatedValueAccess().getAggregatorAssignment_1(), "rule__AggregatedValue__AggregatorAssignment_1");
					put(grammarAccess.getAggregatedValueAccess().getCallAssignment_2(), "rule__AggregatedValue__CallAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.incquery.patternlanguage.rdf.ui.contentassist.antlr.internal.InternalRdfPatternLanguageParser typedParser = (org.eclipse.incquery.patternlanguage.rdf.ui.contentassist.antlr.internal.InternalRdfPatternLanguageParser) parser;
